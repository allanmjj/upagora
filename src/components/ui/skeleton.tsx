...
function CardSkeleton({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div className={cn("rounded-xl border border-zinc-800 bg-zinc-900/50 p-4", className)} {...props}>
...
// Avatar Skeleton
function AvatarSkeleton({ count = 1 }: { count?: number }) {
  return (
    <div className="flex items-center gap-3">
      <Skeleton className="h-10 w-10 rounded-full" />
      {count > 0 && (
...
export { Skeleton, CardSkeleton, PostSkeleton, MarketSkeleton, ProjectSkeleton, AvatarSkeleton }
